...
import com.richard.bigdata.weblog.mrbean.PageViewsBean;
import com.richard.bigdata.weblog.mrbean.VisitBean;
...
//		FileOutputFormat.setOutputPath(job, new Path(args[1]));
		FileInputFormat.setInputPaths(job, new Path("D:\\textcode\\web_clike_mr_log\\visits\\input"));
		FileOutputFormat.setOutputPath(job, new Path("D:\\textcode\\web_clike_mr_log\\visits\\output"));
